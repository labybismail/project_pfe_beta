				...
				<div class="fxt-form">
                    ...
                    <div class="form-group">
							<div class="fxt-transformY-50 fxt-transition-delay-2">
								<input id="password" type="password" class="form-control" name="password" placeholder="create a new password" >
								<i toggle="#password" class="fa fa-fw fa-eye toggle-password field-icon"></i>
							</div>
						</div>
                        <div class="form-group">
							<div class="fxt-transformY-50 fxt-transition-delay-2">
								<input id="password2" type="password" class="form-control" name="password2" placeholder="confirm your password" >
								<i toggle="#password2" class="fa fa-fw fa-eye toggle-password field-icon"></i>
							</div>
						</div>
						<div class="form-group">
							<div class="fxt-transformY-50 fxt-transition-delay-4">
								<input type="submit" name="submit" class="fxt-btn-fill" value="change password">
							</div>
						</div>
		 ...
		 $password2=$_POST['password2'];
		  ...
		  try
		  {
                             if($password==$password2)
                             {
                              ...
                              <span>your password has been changed succesfuly.</span>
                             </div>';
                             mysqli_query($conn,"UPDATE `users` SET `password`='$password' WHERE email='$email'");
							 
                             header('refresh:2; url= login-23.php');
                             }

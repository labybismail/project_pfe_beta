                                    ...
                                    <table class="table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                            @php
                                                ...
                                                function doctorProfileImage1($nom, $prenom)
                                                {
                                                        ...
                                                        <h2 class="table-avatar">
                                                            <a class="avatar avatar-sm mr-2">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="{{ doctorProfileImage1($doctor->user->nom, $doctor->user->prenom) }}"
                                                                    alt="User Image">
                                                            </a>
                                        ...
                                        <tbody>
                                            @foreach ($patients as $patient)
                                                <tr>
                                                    ...
                                                    <td>{{ $patient->user->created_at ? Carbon\Carbon::parse($patient->user->created_at)->format('d F Y') : '' }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a class="avatar avatar-sm mr-2"><img
                                                                    ...
                                                                    src="{{ doctorProfileImage1($consultation->doctor->user->nom,$consultation->doctor->user->prenom) }}"
                                                                    alt="User Image"></a>
                                                            Dr.
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a class="avatar avatar-sm mr-2"><img
                                                                    class="avatar-img rounded-circle"
                                                                    src="{{ patientProfileImage($consultation->patient->user->nom,$consultation->patient->user->prenom) }}"
                                                                    alt="User Image"></a>

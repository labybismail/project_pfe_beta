...
<!-- Mirrored from doccure-html.dreamguystech.com/template/doctor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jul 2021 13:16:55 GMT -->
                            ...
                            <div class="doc-info-left">
                                ...
                                <div class="doc-info-cont">
                                    ...
                                    <div class="clinic-details">
                                        <p class="doc-location"><i class="fas fa-map-marker-alt"></i> {{ $doctor->user->address }}
                    ...
                    <div class="card-body pt-0">
                        ...
                        <nav class="user-tabs mb-4">
                            <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#doc_business_hours" data-toggle="tab">Business
                                        Hours</a>
                                </li>
                            </ul>
                        </nav>
                            ...
                            <div role="tabpanel" id="doc_locations" class="tab-pane fade">
                                            ...
                                            <div class="clinic-content">
                                                ...
                                                <div class="clinic-details mb-0">
                                                    <h5 class="clinic-direction"> <i
                                                            class="fas fa-map-marker-alt"></i> 2286 Sundown Lane,
                                                        Austin, Texas 78749, USA <br><a href="javascript:void(0);">Get
                                                            Directions</a></h5>
                                                    <ul>
                                                        <li>
                                ...
                                <div class="location-list">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="clinic-content">
                                                <h4 class="clinic-name"><a href="#">The Family Dentistry
                                                        Clinic</a></h4>
                                                <p class="doc-speciality">MDS - Periodontology and Oral Implantology,
                                                    BDS</p>
                                                <div class="rating">
                                                ...
                                                <div class="clinic-details mb-0">
                                                    <p class="clinic-direction"> <i class="fas fa-map-marker-alt"></i>
                                                        2883 University Street, Seattle, Texas Washington, 98155 <br><a
                                            ...
                                            <div class="widget-content">
                                                <div class="listing-hours">
                                                    {{-- <div class="listing-day current">
                                                        <div class="day">Today <span>{{ \Carbon\Carbon::now()->translatedFormat('D d F Y') }}</span></div>
                                                        <div class="time-items">
                                                            <span class="open-status"><span
                                                                    class="badge bg-success-light">Open
                                                                    Now</span></span>
                                                            <span class="time">09:00 AM - 4:00 PM</span>
                                                        </div>
                                                    </div> --}}

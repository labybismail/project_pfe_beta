...
<!-- Mirrored from doccure-html.dreamguystech.com/template/admin/doctor-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jul 2021 13:17:43 GMT -->
<head>
        <meta charset="utf-8">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Dr. {{$doctor->user->nom.' '.$doctor->user->prenom}}</a>
														</h2>
													</td>

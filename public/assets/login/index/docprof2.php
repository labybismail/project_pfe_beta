						...
						<div class="card-body">
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<span class="notranslate"> 	<h4 class="doc-name"><?php echo $row["name"]?>&nbsp<?php echo $row["surname"] ?></h4></span>
				...
				<div class="col-md-6 offset-md-3">
					 ...
					 <!-- Form -->
					        ...
					        <form method="post" action="">
									...
									<div class="form-group">
										<input class="btn btn-primary btn-block col-12 col-md-8" type="submit" value="Set Appointment" name ="submit">
									</div>
								</form>
								<!-- /Form -->
								<?php
                        ...
                        {
							if (empty ($_POST['date3']) or empty($_POST['time1'])){
